...
class LogConsoleTab {
    constructor(url, title, icon, active, first, logEntries, getDomElementsCallback, getIdStringLookupCallback) {
        ...
        console.assert(typeof(getDomElementsCallback) === "function");
        ...
        this._active = active;
        this._first = first;
        this._getDomElementsCallback = getDomElementsCallback;
    ...
    addEntry(logEntry) {
        const domElements = this._getDomElementsCallback();

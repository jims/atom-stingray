...
class StingrayPackage {
    constructor(state) {
        ...
        this.disposables.add(atom.commands.add("atom-workspace", "stingray:toggleConsole", this.toggleConsole.bind(this)));
        this.disposables.add(atom.commands.add("atom-workspace", "stingray:runProject", this.runProject.bind(this)));

...
import fs from 'fs';
import {showHelpList, createHelpView} from "./stingray/help"
import url from 'url';
...
class StingrayPackage {
    constructor(state) {
        ...
        this.adoc = Toolchain.runningToolchainPath().flatMap(adoc);
        this.adoc.subscribe(console.log.bind(console));
    }
    ...
    opener(uri) {
      ...
      if (o.protocol === "stingray-help:") {
        return createHelpView(o.pathname.substr(1));
      }
    }

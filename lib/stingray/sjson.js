...
export class SJSON {
    static parse(s) {
        ...
        const identifier = characterMask("0123456789abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ_");
        const number = characterMask("-+0123456789");
        const numberExp = characterMask(".eE");

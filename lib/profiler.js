...
class ProfilerElementImpl extends HTMLElement {
    ...
    update() {
        ...
        drawHistory(this._history.getContext("2d"), profiler.historyData, profiler.historyFrameTimes, viewedHistoryIndex, this._hoveredHistoryIndex, this._history.width, this._history.height);
    }
}

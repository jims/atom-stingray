...
const historyColors = Object.freeze({
    ...
    barBackgroundHovered: theme.darkForeground,
...
function drawHistory(context, historyData, historyFrameTimes, hoveredHistoryIndex, width, height) {
...
class ProfilerElementImpl extends HTMLElement {
    ...
    update() {
        ...
        drawHistory(this._history.getContext("2d"), profiler.historyData, profiler.historyFrameTimes, this._hoveredHistoryIndex, this._history.width, this._history.height);
    }
}
